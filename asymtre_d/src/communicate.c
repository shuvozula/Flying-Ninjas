...
int create_broadcast(int portnum, int index)
{
  ...
  //sprintf(ip_addr, "160.36.59.255"); // the broadcast address of CS network
  //sprintf(ip_addr, "160.36.255.255"); // on laptop 52, cs network 
  sprintf(ip_addr, "10.26.210.255"); // dilab network
