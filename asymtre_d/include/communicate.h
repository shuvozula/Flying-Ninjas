...
#define PORT_H 4950 // the port for the help thread
#define PORT_R 4951 // the port for the request thread
#define PORT_M 4952 // the port for the monitor thread
#define MAXBUF 1024 // maximum length of the buffer
#define TIMEOUT 3 // 3 seconds
#define TIMEOUT2 6 // 9 seconds
